...
## Project Structure
    ...
    ├── inventory_tracker_37517  # Django project configurations
...
1. Clone this repo and `cd inventory_tracker_37517`
...
2. Clone this repo and `cd inventory_tracker_37517`
